...
setLegend(
  [spark, bitmap`................\n................\n.......6........\n.......6........\n....6..6..6.....\n.....66666......\n......666.......\n.....66666......\n....6..6..6.....\n.......6........\n.......6........\n................\n................\n................\n................\n................`],
  [cursorMark, bitmap`6666........6666\n66............66\n6..............6\n6..............6\n................\n................\n................\n................\n................\n................\n................\n................\n6..............6\n6..............6\n66............66\n6666........6666`],
  [wheelIcon, bitmap`................\n.....666666.....\n...6663333666...\n..663331113366..\n..633111111336..\n.66311333113366.\n.63113311133136.\n.63113111113136.\n.63113311133136.\n.66311333113366.\n..633111111336..\n..663331113366..\n...6663333666...\n.....666666.....\n................\n................`],
  [bjIcon, bitmap`00..0...........\n..0.0.....00....\n.0..0...00220...\n0...0..022220...\n000.0..0222220..\n........020020..\n....00..0220220.\n..00220..022220.\n.022220..02200..\n.0223220..00....\n..023320........\n..0222220..33..3\n...022220....3.3\n...02200....3..3\n....00.....3...3\n...........333.3`],
  [rouletteIcon, bitmap`.....CCCCCC.....\n...CC033330CC...\n..C0003333000C..\n.C330003300003C.\n.C333003300033C.\nC33333033003333C\nC00333366033300C\nC00000666600000C\nC00000666600000C\nC00333066333300C\nC33330033033333C\n.C330003300333C.\n.C300003300033C.\n..C0003333000C..\n...CC033330CC...\n.....CCCCCC.....`],
  [bingoIcon, bitmap`0000000000000000\n0220220220220220\n0220220220220220\n0000000000000000\n0220220220220220\n0220220220220220\n0000000000000000\n0220220230220220\n0220220320220220\n0000000000000000\n0240240240240240\n0420420420420420\n0000000000000000\n0220220220220220\n0220220220220220\n0000000000000000`],
  [w1, bitmap`................\n....66666666....\n...6677777766...\n..667777777766..\n..677770777776..\n..677700777776..\n..677770777776..\n..677770777776..\n..677000007776..\n..677777777776..\n..667777777766..\n...6677777766...\n....66666666....\n................\n................\n................`],
  [w2, bitmap`................\n....66666666....\n...6677777766...\n..667777777766..\n..677000007776..\n..677777707776..\n..677000007776..\n..677077777776..\n..677000007776..\n..677777777776..\n..667777777766..\n...6677777766...\n....66666666....\n................\n................\n................`],
  [w3, bitmap`................\n....66666666....\n...6644444466...\n..664444444466..\n..644000004446..\n..644444404446..\n..644400004446..\n..644444404446..\n..644000004446..\n..644444444446..\n..664444444466..\n...6644444466...\n....66666666....\n................\n................\n................`],
  [w5, bitmap`................\n....66666666....\n...6699999966...\n..669999999966..\n..699000009996..\n..699099999996..\n..699000009996..\n..699999909996..\n..699000009996..\n..699999999996..\n..669999999966..\n...6699999966...\n....66666666....\n................\n................\n................`],
  ...
  [chip, bitmap`................\n................\n.....333333.....\n....33111133....\n...3313331333...\n...3131111133...\n...3131111133...\n...3313331333...\n....33111133....\n.....333333.....\n................\n................\n................\n................\n................\n................`],
  [skull, bitmap`................\n................\n.....111111.....\n....11111111....\n...1100110011...\n...1100110011...\n...1111111111...\n...1110001111...\n....11111111....\n.....101010.....\n.....111111.....\n......1111......\n................\n................\n................\n................`],
  [cherry, bitmap`0000000000000000\n0111111111111110\n0111111411111110\n0111114411111110\n0111144111111110\n0111333311111110\n0113333331111110\n0113333331111110\n0111333311111110\n0111133111111110\n0111111111111110\n0111111111111110\n0111111111111110\n0111111111111110\n
  [slotTopR, bitmap`................\n................\n666666666666....\n69999999999966..\n699999999999966.\n666666666669996.\n.666666666669966\n..6999999999996.\n..6999999999996.\n..6999999999996.\n..6999999999996.\n..6999999999996.\n..6999999999996.\n...6999999999...\n....0000000000..\n................`],
  [slotSideL, bitmap`................\n..6666666666....\n.669999999966...\n.699999999996...\n.699666666666...\n.6996...........\n.6996...........\n.6996...........\n.6996...........\n.6996...........\n.699666666666...\n.699999999996...\n.669999999966...\n..6666666666....\n................\n................`],
  ...
  [slotBase, bitmap`................\n0000000000000000\n6999999999999996\n6999999999999996\n6996666666666996\n6996........6996\n6996........6996\n6996666666666996\n6999999999999996\n6999999999999996\n6666666666666666\n3333333333333333\n.33333333333333.\n..000000000000..\n................\n................`],
  [slotBaseR, bitmap`................\n..000000000000..\n..6999999999996.\n..6999999999996.\n..6996666666696.\n..696......6996.\n..696......6996.\n..6996666666696.\n..6999999999996.\n..6999999999996.\n..6666666666666.\n..333333333333..\n...3333333333...\n....00000000....\n................\n................`],
  [reelFrame, bitmap`6666666666666666\n6999999999999996\n69............96\n69............96\n69............96\n69............96\n69............96\n69............96\n69............96\n69............96\n69............96\n69............96\n69............96\n6999999999999996\n6666666666666666\n................`],
  [slotHandle, bitmap`................\n.........6666...\n........699996..\n........699996..\n.........6666...\n.......66.......\n.....66.........\n....66..........\n...66...........\n..66............\n.66.............\n66..............\n6...............\n................\n................\n................`],
  [slotHandleDown, bitmap`................\n66..............\n.66.............\n..66............\n...66...........\n....66..........\n.....66.........\n.......66.......\n.........6666...\n........699996..\n........699996..\n.........6666...\n................\n................\n................\n................`],
  [cardBack, bitmap`0666666666666660\n0611111111111160\n0611113333311160\n0611111111311160\n0611111113311160\n0611111133111160\n0611111331111160\n0611111331111160\n0611111111111160\n0611111331111160\n0611111111111160\n0611111111111160\n0611111111111160\n0611111111111160\n0666666666666660\n0000000000000000`],
  [bjTL, bitmap`................\n................\n................\n......0000000000\n....00LLLLLLLLLL\n...0LL1111111111\n..0L112222222222\n..0L122222222222\n.0L1222222222222\n.0L1222222222222\n.0L1222222222222\n.0L1222222222222\n.0L1222222222222\n.0L1222222222222\n.0L1222222222222\n.0L1222222222222`],
  [bjTR, bitmap`................\n................\n................\n0000000000......\nLLLLLLLLLL00....\n1111111111LL0...\n222222222211L0..\n222222222221L0..\n2222222222221L0.\n2222222222221L0.\n2222222222221L0.\n2222222222221L0.\n2222222222221L0.\n2222222222221L0.\n2222222222221L0.\n2222222222221L0.`],
  [bjBL, bitmap`.0L1222222222222\n.0L1222222222222\n.0L1222222222222\n.0L1222222222222\n.0L1222222222222\n.0L1222222222222\n.0L1222222222222\n.0L1222222222222\n..0L122222222222\n..0L112222222222\n...0LL1111111111\n....00LLLLLLLLLL\n......0000000000\n................\n................\n................`],
  [bjBR, bitmap`2222222222221L0.\n2222222222221L0.\n2222222222221L0.\n2222222222221L0.\n2222222222221L0.\n2222222222221L0.\n2222222222221L0.\n2222222222221L0.\n222222222221L0..\n222222222211L0..\n1111111111LL0...\nLLLLLLLLLL00....\n0000000000......\n................\n................\n................`],
  [bjL, bitmap`.0L1222222222222\n.0L1222222222222\n.0L1222222222222\n.0L1222222222222\n.0L1222222222222\n.0L1222222222222\n.0L1222222222222\n.0L1222222222222\n.0L1222222222222\n.0L1222222222222\n.0L1222222222222\n.0L1222222222222\n.0L1222222222222\n.0L1222222222222\n.0L1222222222222\n.0L1222222222222`],
  [bjR, bitmap`2222222222221L0.\n2222222222221L0.\n2222222222221L0.\n2222222222221L0.\n2222222222221L0.\n2222222222221L0.\n2222222222221L0.\n2222222222221L0.\n2222222222221L0.\n2222222222221L0.\n2222222222221L0.\n2222222222221L0.\n2222222222221L0.\n2222222222221L0.\n2222222222221L0.\n2222222222221L0.`],
  [bjHeart, bitmap`2222222222221L0.\n2222222222221L0.\n2222222222221L0.\n2222222222221L0.\n2222222222221L0.\n2222222222221L0.\n2222222222221L0.\n2222222222221L0.\n2223322233221L0.\n2233332333321L0.\n2233333333321L0.\n2233333333321L0.\n2223333333221L0.\n2222333332221L0.\n2222233322221L0.\n2222223222221L0.`],
  [bjDiamond, bitmap`2222222222221L0.\n2222222222221L0.\n2222222222221L0.\n2222222222221L0.\n2222222222221L0.\n2222222222221L0.\n2222222222221L0.\n2222223222221L0.\n2222233322221L0.\n2222333332221L0.\n2223333333221L0.\n2233333333321L0.\n2223333333221L0.\n2222333332221L0.\n2222233322221L0.\n2222223222221L0.`],
  [bjSpade, bitmap`2222222222221L0.\n2222222222221L0.\n2222222222221L0.\n2222222222221L0.\n2222222222221L0.\n2222222222221L0.\n2222222222221L0.\n2222220222221L0.\n2222200022221L0.\n2222000002221L0.\n2220000000221L0.\n2200000000021L0.\n2200000000021L0.\n2220020200221L0.\n2222200022221L0.\n2222000002221L0.`],
  [bjClub, bitmap`2222222222221L0.\n2222222222221L0.\n2222222222221L0.\n2222222222221L0.\n2222222222221L0.\n2222222222221L0.\n2222222222221L0.\n2
  [bingoXL, bitmap`0000000000000000\n04..............\n0.44............\n0...44..........\n0.....444.......\n0........444....\n0...........444.\n0..............4\n0..............4\n0...........444.\n0........444....\n0.....444.......\n0...44..........\n0.44............\n04..............\n0000000000000000`],
  [bingoXR, bitmap`0000000000000000\n..............40\n............44.0\n..........44...0\n.......444.....0\n....444........0\n.444...........0\n4..............0\n4..............0\n.444...........0\n....444........0\n.......444.....0\n..........44...0\n............44.0\n..............40\n0000000000000000`],
  [bingoXL2, bitmap`0000000000000000\n03..............\n0.33............\n0...33..........\n0.....333.......\n0........333....\n0...........333.\n0..............3\n0..............3\n0...........333.\n0........333....\n0.....333.......\n0...33..........\n0.33............\n03..............\n0000000000000000`],
  [bingoXR2, bitmap`0000000000000000\n..............30\n............33.0\n..........33...0\n.......333.....0\n....333........0\n.333...........0\n3..............0\n3..............0\n.333...........0\n....333........0\n.......333.....0\n..........33...0\n............33.0\n..............30\n0000000000000000`],
...
function canBgmPlay() { return BGM_STATES.has(state);
}
function startBgm() {
...
function playSound(t, delay = 0) {
  if (delay > 0) duckBgm(delay);
  playTune(t);
}
...
function drawBlackjack() {
  ...
  if (bjMsg) {
    const isLoss = bjMsg.includes("LOST") || bjMsg.includes("BUST");
    txtR(bjMsg, 7, isLoss ? color`3` : color`6`);
...
function rouBetName() {
  ...
  const numStr = rouPick === 37 ? "00" : rouPick;
  return t + (t === "NUM" ? " " + numStr : "");
}
...
function drawRouletteResult() {
  ...
  let resCol;
  if (rouColor === "RED") { resCol = color`3`; }
  else if (rouColor === "BLACK") { resCol = color`2`; }
  else { resCol = color`4`; }
...
function bingoLetterColor(l) {
  if (l === "B") return color`3`;
  if (l === "I") return color`9`;
  if (l === "N") return color`4`;
  if (l === "G") return color`7`;
  return color`H`;
}
function drawBingoGrid() {
  ...
  for (let r = 0; r < 5; r++) {
    for (let c = 0; c < 5; c++) {
      const x = c * 2, y = r + 3, n = bingoCard[r][c], marked = bingoMarks[r]?.[c];
      ...
      const selLabel = n === 0 ? "FR" : label;
      const defLabel = n === 0 ? "FREE" : " " + label;
      const cellText = selected ? ">" + selLabel : defLabel;
      let cellColor;
      if (selected) { cellColor = color`6`; }
      else if (marked) { cellColor = color`4`; }
      else if (isActive) { cellColor = color`6`; }
...
function bingoNearMiss() {
  for (let r = 0; r < 5; r++) {
    let cnt = 0;
    for (let c = 0; c < 5; c++) if (bingoMarks[r]?.[c]) cnt++;
    if (cnt === 4) return true;
  }
  for (let c = 0; c < 5; c++) {
    let cnt = 0;
    for (let r = 0; r < 5; r++) if (bingoMarks[r]?.[c]) cnt++;
    if (cnt === 4) return true;
  }
  let d1 = 0, d2 = 0;
  for (let i = 0; i < 5; i++) {
    if (bingoMarks[i]?.[i]) d1++;
    if (bingoMarks[i]?.[4 - i]) d2++;
  }
  return d1 === 4 || d2 === 4;
}
